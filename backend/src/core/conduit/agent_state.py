...
class AgentState(Component[[Channel[TextFrame], Channel[TextFrame], Channel[InterruptFrame]], AgentStateOutputs]):
    ...
    def run(
        ...
        def process_asr():
            ...
            for text_frame in asr.stream(self):
                ...
                self._output_messages.send(MessagesFrame(
        ...
        def process_feedback():
            ...
            for text_frame in feedback.stream(self):
                ...
                with self._lock:
                    ...
                    if self._history and self._history[-1][0] == self.config.chatbot_name:
